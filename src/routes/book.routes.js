...
const getBook = async(req, res, next) => {
    ...
    //  validación para comprobar si un ID tiene el formato correcto de un ObjectId de MongoDB
...
router.patch('/:id', getBook, async(req, res) => {
    ...
    if (!req.body.title && !req.body.author && !req.body.gender && !req.body.publication_date){
        res.status(400).json({
            message: 'Al menos uno de estos campos debe ser enviado: Titulo, Autor, genero, fechaPublicacion'
        })
    }
    try {
